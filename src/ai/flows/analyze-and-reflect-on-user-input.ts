...
const AnalyzeAndReflectOnUserInputInputSchema = z.object({
  userInput: z
    .string()
    .describe(
      "The user's input, which can be a problem, concern, or completed win.",
    ),
  vision: z
    .string()
    .describe(
      "The user's overall vision and goals, to provide context for the analysis.",
    ),
});
export type AnalyzeAndReflectOnUserInputInput = z.infer<
  typeof AnalyzeAndReflectOnUserInputInputSchema
>;
...
export type AnalyzeAndReflectOnUserInputOutput = z.infer<
  typeof AnalyzeAndReflectOnUserInputOutputSchema
>;

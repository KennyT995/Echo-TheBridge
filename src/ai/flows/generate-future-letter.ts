...
const GenerateFutureLetterInputSchema = z.object({
    ...
    recentLogs: z.array(z.string()).optional().describe("Summaries of recent daily logs or streak status."),
    streakCount: z.number().optional().describe("Current daily streak count."),
});

export type GenerateFutureLetterInput = z.infer<typeof GenerateFutureLetterInputSchema>;

const GenerateFutureLetterOutputSchema = z.object({
    subject: z.string().describe("The email subject line."),
    body: z.string().describe("The content of the letter written by the Future Self."),
    tone: z.enum(['encouraging', 'urgent', 'celebratory']).describe("The emotional tone of the letter."),
});

export type GenerateFutureLetterOutput = z.infer<typeof GenerateFutureLetterOutputSchema>;

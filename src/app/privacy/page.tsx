      ...
      <main className="flex-1 py-12 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          <h1 className="font-headline text-4xl md:text-5xl font-bold tracking-tight mb-8">
            Privacy <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-indigo-500">Policy</span>
          </h1>
          <div className="prose prose-invert max-w-none text-muted-foreground">
            <p className="lead text-xl text-foreground mb-8">
              Your privacy is critically important to us. At Echo: The Bridge,
            ...
            <p className="mb-4">
              **Log Data:** Like most website operators, Echo: The Bridge
            ...
            <p className="mb-4">
              **Personal Information:** When you sign up for an account, we ask
              for personal information such as your name and email address. When
              you create a vision, we store the content you provide to generate
              your roadmap.
            </p>
            ...
            <p className="mb-4">
              ...
              and improve our services, to develop new ones, and to protect
              Echo: The Bridge and our users. We also use this information to
              offer you tailored content – like giving you more relevant roadmap
              suggestions.
            </p>
            ...
            <p className="mb-4">
              To provide our core service, your goal descriptions are processed
              by our AI partners (e.g., Google Gemini) to generate roadmaps. We
              have agreements in place to ensure this data is used solely for
              generating your output and is not used to train third-party
              models.
            </p>

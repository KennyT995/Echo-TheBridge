...
export type VisionCategory = (typeof visionCategories)[number];
...
export const VisionFormSchema = z.object({
  ...
  goal: z
    ...
    .min(
      10,
      "Your goal should be at least 10 characters long to provide enough context for the AI.",
    ),

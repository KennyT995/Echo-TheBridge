...
export function FutureLetterModal({ open, onOpenChange, letter, isLoading, onGenerate }: FutureLetterModalProps) {
            ...
            <DialogContent className="sm:max-w-xl bg-gradient-to-br from-card to-indigo-950/20 border-indigo-500/20">
                <DialogHeader>
                    <div className="flex items-center gap-2 text-indigo-500 mb-2">
                        ...
                        <span className="text-sm font-medium uppercase tracking-wider">Quantum Mail</span>
                    </div>
                    <DialogTitle className="text-2xl font-serif tracking-wide">Letters from Tomorrow</DialogTitle>
                    <DialogDescription>
                    ...
                    {!letter && !isLoading && (
                        <div className="text-center space-y-4 max-w-sm">
                            ...
                            <p className="text-muted-foreground">
                                No unread messages. Sometimes the signal from the future needs a boost.
                            </p>
                    ...
                    {letter && (
                        <div className="w-full animate-in fade-in zoom-in-95 duration-500">
                            <div className="bg-card border shadow-sm rounded-lg p-6 relative overflow-hidden">
                                ...
                                <h3 className="font-bold text-lg mb-4 border-b pb-2">{letter.subject}</h3>
                                ...
                                <div className="mt-6 pt-4 border-t flex justify-between items-center text-xs text-muted-foreground">
                                    ...
                                    <span className={cn(
                                        ...
                                        letter.tone === 'encouraging' && "text-green-500 border-green-200",
                                        letter.tone === 'urgent' && "text-red-500 border-red-200",
                                        letter.tone === 'celebratory' && "text-blue-500 border-blue-200",
                                    )}>
                                        Tone: {letter.tone}
                                    </span>
                                </div>

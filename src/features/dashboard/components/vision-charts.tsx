...
export function VisionCharts({ visions, roadmaps }: VisionChartsProps) {
  ...
  // Moved conditional return to the bottom to respect Rules of Hooks
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              How your visions are spread across different life areas.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ChartContainer
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Average completion rate for each vision category.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ChartContainer
            ...
            >
              ...
              >
                ...
                <ChartTooltip
                  cursor={false}
                  content={
                    <ChartTooltipContent indicator="line" labelKey="name" />
                  }
                />

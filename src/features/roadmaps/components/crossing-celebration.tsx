...
export function CrossingCelebration({ progress, roadmapTitle = "your roadmap", onClose }: CrossingCelebrationProps) {
        ...
        <Dialog open={isOpen} onOpenChange={(open) => {
            ...
            <DialogContent className="sm:max-w-md border-yellow-500/20 bg-gradient-to-b from-background to-yellow-500/5">
                <DialogHeader>
                    ...
                    <DialogTitle className="text-center text-2xl font-bold">The Crossing Complete!</DialogTitle>
                    <DialogDescription className="text-center pt-2 text-base">
                        You have successfully built the bridge for <br />
                        <span className="font-semibold text-foreground">&quot;{roadmapTitle}&quot;</span>.
                    </DialogDescription>
                </DialogHeader>

                <div className="py-6 space-y-4 text-center">
                    <p className="text-muted-foreground">
                        This is a monumental step. You are no longer the same person who started this journey.
                    </p>
                ...
                <DialogFooter className="sm:justify-center">
                    <Button onClick={() => setIsOpen(false)} className="w-full sm:w-auto font-semibold">

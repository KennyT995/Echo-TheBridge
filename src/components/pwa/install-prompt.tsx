                ...
                <div className="space-y-4 py-4">
                    ...
                    {platform === 'android' && (
                        <div className="flex flex-col gap-4">
                            <div className="flex items-center gap-3">
                                ...
                                <p className="text-sm">1. Tap the <strong>Menu</strong> (three dots) icon.</p>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="bg-muted p-2 rounded-md">
                    ...
                    {platform === 'desktop' && (
                        <div className="text-sm text-muted-foreground">
                            To install on desktop, look for the install icon <Download className="inline h-3 w-3" /> in your address bar (Chrome/Edge).
                        </div>
                    )}
                </div>
            </DialogContent>

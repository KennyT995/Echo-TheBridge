    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            {children}
            <SidebarRail onDoubleClick={toggleSidebar} />
          </div>
        </div>
      </div>
    );
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn(
        'flex h-14 items-center justify-between gap-2 border-b p-4',
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        'flex min-h-0 flex-1 flex-col gap-2 overflow-auto p-4 group-data-[collapsible=icon]:items-center group-data-[collapsible=icon]:overflow-hidden group-data-[collapsible=icon]:p-2',
        className
      )}
      {...props}
    />
